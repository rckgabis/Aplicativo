...
import Alertas from '../pages/client/Alertas';
import Relatorio from '../pages/client/Relatorio';
...
import Sobre from '../pages/client/Sobre';
import Ajuda from '../pages/client/Ajuda';
  ...
  return (
    <DrawerLayoutAndroid
      ...
      renderNavigationView={() => (
        <View style={styles.drawerContainer}>
          ...
          {renderDrawerMenuItem('Ajuda', 'help-circle', () => navigation.navigate('Ajuda'))}
    ...
    >
      ...
      <Tab.Screen name="Alertas" children={() => <ScreenWithHeader component={Alertas} openDrawer={openDrawer} />} options={{ headerShown: false }} />
        ...
        <Tab.Screen name="Ajuda" children={() => <ScreenWithHeader component={Ajuda} openDrawer={openDrawer} />} options={{ headerShown: false, tabBarButton: () => null }} />
